# CS1 Lab - STL - Deque and Unittest - A

Possible Points: 100

Write a C++ program to solve the Kattis problemid overnightoats: [https://open.kattis.com/problems/overnightoats](https://open.kattis.com/problems/overnightoats). Note that the last part of the URL, e.g. `overnightoats` is the problem id. Read the problem statement carefully to design a correct solution.
