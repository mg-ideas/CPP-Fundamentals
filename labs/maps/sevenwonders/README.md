...
Write a C++ program to solve the Kattis problemid sevenwonders: [https://open.kattis.com/problems/sevenwonders](https://open.kattis.com/problems/sevenwonders). Note that the last part of the URL, e.g. `sevenwonders` is the problem id. Read the problem statement carefully to design a correct solution.
