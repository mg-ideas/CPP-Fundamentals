# CS1 Lab - Maps/Sets and Unittest

Possible Points: 100

Write a C++ program to solve the Kattis problemid baconeggsandspam: [https://open.kattis.com/problems/baconeggsandspam](https://open.kattis.com/problems/baconeggsandspam). Note that the last part of the URL, e.g. `baconeggsandspam` is the problem id. Read the problem statement carefully to design a correct solution.
