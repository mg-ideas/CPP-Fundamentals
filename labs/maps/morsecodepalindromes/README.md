# CS1 Lab - Unordered Maps and Unittest

Possible Points: 100

Write a C++ program to solve the Kattis problemid morsecodepalindromes: [https://open.kattis.com/problems/morsecodepalindromes](https://open.kattis.com/problems/morsecodepalindromes). Note that the last part of the URL, e.g. `morsecodepalindromes` is the problem id. Read the problem statement carefully to design a correct solution.
