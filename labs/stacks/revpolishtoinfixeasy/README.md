...
Write a C++ program to solve the Kattis problemid revpolishtoinfixeasy: [https://open.kattis.com/problems/revpolishtoinfixeasy](https://open.kattis.com/problems/revpolishtoinfixeasy). Note that the last part of the URL, e.g. `revpolishtoinfixeasy` is the problem id. Read the problem statement carefully to design a correct solution.
