# CS1 Lab - Stirngs and Unittest - A

Possible Points: 100

Write a C++ program to solve the Kattis problemid hissingmicrophone: https://open.kattis.com/problems/hissingmicrophone. Read the problem statement carefully to design a correct solution.
