...
Write a C++ program to solve the Kattis problemid gestalisti: [https://open.kattis.com/problems/gestalisti](https://open.kattis.com/problems/gestalisti). Note that the last part of the URL, e.g. `gestalisti` is the problem id. Read the problem statement carefully to design a correct solution.
