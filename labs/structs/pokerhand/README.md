# CS1 Lab - Structs and Unittest - B

Possible Points: 100

Write a C++ program to solve the Kattis problemid pokerhand: [https://open.kattis.com/problems/pokerhand](https://open.kattis.com/problems/pokerhand). Note that the last part of the URL, e.g. `pokerhand` is the problem id. Read the problem statement carefully to design a correct solution.
