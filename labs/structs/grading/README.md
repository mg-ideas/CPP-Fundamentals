...
Write a C++ program to solve the Kattis problemid grading: [https://open.kattis.com/problems/grading](https://open.kattis.com/problems/grading). Note that the last part of the URL, e.g. `grading` is the problem id. Read the problem statement carefully to design a correct solution.
